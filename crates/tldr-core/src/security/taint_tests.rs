...
// Section 2/3 Python detection tests that used them. The remaining
// Ruby / Elixir / OCaml `test_<lang>_detect_sources/sinks` tests still
// import `detect_sources` / `detect_sinks` directly.
use super::taint::{
    detect_sanitizer, detect_sinks, detect_sources, find_sanitizers_in_statement, is_sanitizer,
};
